...
def read_options():
    ...
    parser.add_argument('--num_rounds',default=400,help='number of rounds to simulate;',type=int)
    parser.add_argument('--eval_every',default=1,help='evaluate every rounds;',type=int)
    parser.add_argument('--clients_per_round',default=60,help='number of clients trained per round;',type=int)
    ...
    parser.add_argument('--rho',default=30,help='rho for regularizer',type=int)
